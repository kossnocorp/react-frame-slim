  ...
  _createClass(Frame, [{
    ...
    value: function renderFrameContents() {
      ...
      if (doc && doc.readyState === 'complete') {
        var win = doc.defaultView || doc.parentView; // TODO: Write tests for it (|| cond)
    ...
    value: function render() {
      return _react2.default.createElement('iframe', this.props.iframeProps || {});
    }
  }]);
...
Frame.propTypes = {
  iframeProps: _react.PropTypes.object,
